sap.ui.define([
    ...
    return class SingleAgencyValueHelp {
        ...
        async open() {
            ...
            if (!this._oDialog) {
                this._oDialog = await Fragment.load({
                    id: oView.getId(),
                    name: "travelprocessor2.view.fragments.travel.SingleAgencyValueHelp",
                    controller: this
                });
        ...
        onOk(oEvent) {
            ...
            if(aTokens && aTokens.length > 0){
                ...
                this._oLocalModel.setProperty("/AgencyID/value",aToken.getKey())
            } 
            this._oDialog.close()
        }
        onAfterClose() {
