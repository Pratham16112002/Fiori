sap.ui.define([
    ...
    "travelprocessor/util/formatter"
], (Controller, Fragment,UIColumn,SearchField,Text,Label,Filter,FilterOperator,Formatter) => {
    "use strict";

    return Controller.extend("travelprocessor.controller.Travel", {
        onInit() {
        },
        formatter : Formatter,
        ...
        agencyValueHelpRequest : function () {
            ...
            if(!this._agencyDialog) {
                Fragment.load({
                    id : oView.getId(),
                    name : "travelprocessor.view.fragments.travel.AgencyValueHelp",
                    controller : this
                }).then((oDialog) => {
        ...
        customerValueHelpRequest: function () {
            ...
            if (!this._customerDialog) {
                Fragment.load({
                    id: oView.getId(),
                    name: "travelprocessor.view.fragments.travel.CustomerValueHelp",
                    controller: this
                }).then((oDialog) => {
